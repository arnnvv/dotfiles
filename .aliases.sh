...
alias drst='docker system prune -a --volumes'
...
alias z='cd "$HOME/Documents/$(fd --type d --max-depth 1 --base-directory $HOME/Documents | fzf)" && fd --type f --hidden --exclude .git | fzf | xargs nvim'
alias sl='solana'
alias lk='brew update && brew ls --formulae | xargs brew upgrade --formulae && brew ls --cask | xargs brew upgrade --cask'
alias kl='brew cleanup'
alias man='tldr'
